...
%.bc: %.cpp
	$(CC) $(CC_FLAGS) -DGEM_FORGE_FIX_INPUT -DGEM_FORGE_DYN_SCHEDULE=2 -DRANDOMIZE -march=knl -fno-unroll-loops $^ -emit-llvm -c -o $@
...
%.exe: %.bc
	${CC} ${CC_FLAGS} -DGEM_FORGE_FIX_INPUT -march=knl -o $@
