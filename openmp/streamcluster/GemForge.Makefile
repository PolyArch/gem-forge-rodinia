...
CC_FLAGS=-gline-tables-only -O3 -I${GEM_FORGE_TOP}/gem5/include -DGEM_FORGE_MALLOC_ARENA_MAX=2 -mllvm -loop-unswitch-threshold=1 -Rpass-analysis=loop-vectorize
