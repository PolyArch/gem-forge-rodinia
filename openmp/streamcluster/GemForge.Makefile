...
CC_FLAGS=-gline-tables-only -O3 -stream-specialize -I${GEM_FORGE_TOP}/gem5/include -DGEM_FORGE_MALLOC_ARENA_MAX=2 -mllvm -loop-unswitch-threshold=1 -Rpass-analysis=loop-vectorize
CC_FLAGS+= -DGEM_FORGE_FIX_ONE_CHUNK
CC_FLAGS+= -DGEM_FORGE_FIX_SP_1
CC_FLAGS+= -DGEM_FORGE_FIX_DIM_16
CC_FLAGS+= -DGEM_FORGE
CC_FLAGS+= -DGEM_FORGE_WARM_CACHE
CC_FLAGS+= -DGEM_FORGE_SWITCH_FL
